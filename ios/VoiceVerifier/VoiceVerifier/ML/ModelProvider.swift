...
// Lazily loads the on-device Torch model used for local embeddings (optional).
// By default the app runs in "server-first" mode and skips local model load
// to keep startup snappy; toggle via UserDefaults key "SkipLocalModel".
