...
## What ships
- `README.md`, `images/` (4 PNGs — UI screenshots + the duration-aware-threshold chart), `LICENSE`. The 1-minute walkthrough video is hosted via GitHub (user-attachments), not committed; it shows the app UI only, no distributable voice data.
